...
>
> You should also create a directory to clone your PyHipp repository by:
>
> Change to your home directory in WSL:
>
> cd ~/
>
> Create a "src" directory to save your source code:
>
> mkdir src
>
...
>
> Check that the upstream repository is set up properly:
>
> git remote -v
>
> If not, do the following to fix it:
>
> git remote add upstream https://github.com/shihchengyen/PyHipp.git
>
> Check again that the upstream repository is set up properly:
>
> git remote -v
>
> You do not need to install PyHipp as we will just be using files from the PyHipp directory.
