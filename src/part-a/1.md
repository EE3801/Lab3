...
| ------ | ------------- | ------ | ------------- | ------ | ------------- |
| 0      | t3a.nano      | 4      | t3a.small     | 8      | c7a.medium    |
| 1      | t3.nano       | 5      | t3.small      | 9      | c5a.large     |
...
Click on the `Owned By Me` button to reveal the drop-down menu and select `Public Snapshots`. Copy and paste the following snapshot id: `snap-0e87df4e208383a50`, and then hit `Return`. After some time, you should see a snapshot with the description `condaenvs` listed, so go ahead and select it.
