...
Click on the `Owned By Me` button to reveal the drop-down menu and select `Public Snapshots`. Copy and paste the following snapshot id: `snap-0e87df4e208383a50`, and then hit `Return`. After some time, you should see a snapshot with the description `condaenvs` listed and selected. 
