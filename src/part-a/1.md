...
Click on the `Owned By Me` button to reveal the drop-down menu and select `Public Snapshots`. Copy and paste the following snapshot id: `snap-0b76898e374c998ca`, and then hit `Return`. You should see a snapshot with the description `ee3801-2021-data` listed and selected. 
