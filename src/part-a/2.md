  ...
  "validationMessages": [
    {
      ...
      "message": "The DeletionPolicy is set to Delete. The storage 'data' will be deleted when you remove it from the configuration when performing a cluster update or deleting the cluster."
    }
  ]
}
```
...
```
-rw-rw-r--  1 ec2-user ec2-user     0 Aug 17 17:25 manual_entry.txt
```
