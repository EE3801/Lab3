...
You should then receive a SNS notification from your EC2 EventBridge rule once the compute node gets set up, but it might still take some time before the job will start running.
