...
> <p class="note"> Note
>
> Your operating system CLI usually ships with a few text editors. One of the is `nano`. Another well-known one that you may have heard of is `vim`. `vim` is much more powerful, but also has a higher learning curve than `nano`. You are welcome to use `vim` instead of `nano` for the rest of this course.
...
| ---------- | --------- | ---------- | ---------- | ---------- | --------- |
| 0          | t3a.large | 4          | t2.large   | 8          | m7i.large |
| 1          | t3.large  | 5          | m6i.large  | 9          | m8i.large |
| 2          | m6a.large | 6          | m5.large   |            |           |
| 3          | m5a.large | 7          | m4.large   |            |           |
...
| Last Digit | Type         | Last Digit | Type         | Last Digit | Type        |
| ---------- | ------------ | ---------- | ------------ | ---------- | ----------- |
| 0          | r5a.2xlarge  | 4          | x8i.2xlarge  | 8          | r5d.2xlarge |
| 1          | r6a.2xlarge  | 5          | r5ad.2xlarge | 9          | r5b.2xlarge |
| 2          | r5.2xlarge   | 6          | r7i.2xlarge  |            |             |
| 3          | r6i.2xlarge  | 7          | r8i.2xlarge  |            |             |
